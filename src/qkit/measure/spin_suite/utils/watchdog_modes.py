...
class Watchdog:
   ...
   stop: bool
    ...
    def limits_check(self, data_node, values):
        ...
        """
        suffixes = {"trace", "retrace", "difference"}
        parts = data_node.split(".")
