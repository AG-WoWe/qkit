...
class adwin_semiconductor(Instrument):
    ...
    def __init__(self,
                 ...
                 processpath_main = str(adbasic_dir / 'ramp_input_V3.TC1'),
                 ...
                 process_path_continuous_10kHz = str(adbasic_dir / 'ADCF_continuous_10kHz_V3.TC4'),
                 process_path_continuous_100kHz = str(adbasic_dir / 'ADCF_continuous_100kHz_V3.TC4'),
                 process_path_continuous_1MHz = str(adbasic_dir / 'ADCF_continuous_1MHz_V3.TC4'),
                 process_path_continuous_4MHz = str(adbasic_dir / 'ADCF_continuous_4MHz_V3.TC4'),
                 devicenumber=1,
                 bootload=True,
