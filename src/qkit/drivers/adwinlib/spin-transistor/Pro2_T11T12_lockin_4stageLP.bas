...
dim fifo_inphase[fifo_len] as float32 as fifo at uncacheable
dim fifo_quadrature[fifo_len] as float32 as fifo at uncacheable
dim fifo_input[fifo_len] as long as fifo at uncacheable
