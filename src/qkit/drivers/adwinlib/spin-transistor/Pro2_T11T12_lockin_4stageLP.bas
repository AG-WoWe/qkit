...
#define tao                 FPar_23   'Low pass tao
'#define maf                 Par_23    'length of moving average in lockin periods
#define report_frequency    FPar_24
#define sample_rate         FPar_25   'sample rate
#define report_samplerate   FPar_26
#define lockin_phase        FPar_27   'lockin reference phase shift (radians)
...
#ENDIF
  ...
  report_samplerate = 1 / (subsampling_samples * process_time)
